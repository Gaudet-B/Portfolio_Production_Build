    ...
    return (
        <div className="border border-danger rounded m-3 p-2 text-center">
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Footer className="d-flex flex-row justify-content-start ps-4">
                    <Button variant="outline-secondary" onClick={handleClose}>
                        Cancel
                    </Button>
                    <Button variant="outline-danger" onClick={handleSubmit} disabled={"disabled"}>
                        Register
                    </Button>
                    <p className="text-secondary ms-3" style={{ fontSize: "10pt", margin: "7px 0 0 0" }}><strong className="text-danger">*</strong>demo - register disabled</p>
                </Modal.Footer>
            </Modal>
        </div>
    )
